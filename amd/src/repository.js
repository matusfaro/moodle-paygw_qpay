...
/**
 * Repository module to encapsulate all of the AJAX requests that can be sent for qpay.
 *
 * @module     paygw_qpay/repository
...
export const getForm = (component, paymentArea, itemId, description) => {
    const request = {
        methodname: 'paygw_qpay_get_code',
        args: {
            component,
...
export const getState = (component, paymentArea, itemId, description) => {
    const request = {
        methodname: 'paygw_qpay_get_status',
        args: {
            component,
            paymentarea: paymentArea,
            itemid: itemId,
...
export const createRedirectUrl = async (component, paymentArea, itemId) => {
    const url = M.cfg.wwwroot + '/payment/gateway/qpay/redirect.php?' +
        'component=' + component +
        '&paymentarea=' + paymentArea +
        '&itemid=' + itemId;
    return url;
