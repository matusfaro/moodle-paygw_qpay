...
/**
 * Privacy Subsystem implementation for paygw_qpay.
 *
 * @package    paygw_qpay
 * @category   privacy
    ...
    paygw_provider
{
    ...
    public static function get_metadata(collection $items): collection
    {
        $items->add_database_table(
            'paygw_qpay',
            [
                'userid'       => 'privacy:metadata:paygw_qpay:userid',
                'status'       => 'privacy:metadata:paygw_qpay:status',
                'timecreated'  => 'privacy:metadata:paygw_qpay:timecreated',
                'timemodified' => 'privacy:metadata:paygw_qpay:timemodified',
            ],
            'privacy:metadata:paygw_qpay'
        );
    ...
    public static function export_payment_data(\context $context, array $subcontext, \stdClass $payment)
    {
        ...
        $subcontext[] = get_string('gatewayname', 'paygw_qpay');
        $record = $DB->get_record('paygw_qpay', ['paymentid' => $payment->id]);
    ...
    public static function delete_data_for_payment_sql(string $paymentsql, array $paymentparams)
    {
        ...
        $DB->delete_records_select('paygw_qpay', "paymentid IN ({$paymentsql})", $paymentparams);
    }
